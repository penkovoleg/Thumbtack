...
public class TestColoredCircle {
    ...
    public void testSetWrongColor() {
        try {
            ColoredCircle coloredCircle = new ColoredCircle(0, 20, 10, "YELLOW");
            fail();
        } catch (ColorException ex) {
            assertEquals(ColorErrorCode.WRONG_COLOR_STRING, ex.getErrorCode());
        }
        try {
            ColoredCircle coloredCircle = new ColoredCircle(0, 20, 10, (String) null);
            fail();
        } catch (ColorException ex) {
            assertEquals(ColorErrorCode.NULL_COLOR, ex.getErrorCode());
        }
        try {
            ColoredCircle coloredCircle = new ColoredCircle(0, 20, 10, (Color) null);
            fail();
        } catch (ColorException ex) {
            assertEquals(ColorErrorCode.NULL_COLOR, ex.getErrorCode());
        }
